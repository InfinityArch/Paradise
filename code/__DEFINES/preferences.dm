...
#define NUMPAD_TARGET 2097152
#define AZERTY 4194304
#define AMBIENT_OCCLUSION 8388608
#define TOGGLES_TOTAL 12582911    // If you add or remove a preference toggle above, make sure you update this define with the total value of the toggles combined
